...
{
	var reviewGen={};
	var reviewdetails=Ext.getCmp('hashtag').getValue();
	if(reviewdetails)
	{
		reviewGen.hashtag=reviewdetails;
	}
					...
					.create(
							'Ext.form.Panel',
							{
								...
								items : [
										{
											xtype : 'textfield',
											fieldLabel : 'Enter Hash Tag Details:',
											id : 'hashtag',
											name : 'hashtag',
											maxLength : 100,
											minLength : 2,
										...
										},
										{
											...
											handler : function(store, btn, args) {
												...
												urlLink = contextPath + '/review/addHashTag.do';
												hideConfirmationMsg();
