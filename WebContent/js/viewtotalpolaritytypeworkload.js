...
Ext.onReady(function () {
	...
	Ext.define('keywordModel',{
		...
		fields : [ 
		          {name:'collegeId',mapping:'collegeId',type:'int'},
		          {name:'collegeType',mapping:'collegeType',type:'int'},
	    ...
	    series: [{
	        ...
	        tips: {
	          ...
	          renderer: function(storeItem, item) {
	            this.setTitle(storeItem.get('collegeId') + ': ' + storeItem.get('positiveRating') + ' Positive Rating');
	          }
	        },
	        label: {
	          display: 'insideEnd',
	...
	Ext.create('Ext.chart.Chart', {
	    ...
	    series: [{
	        ...
	        tips: {
	          ...
	          height: 28,
	          renderer: function(storeItem, item) {
	            this.setTitle(storeItem.get('collegeId') + ': ' + storeItem.get('negativeRating') + ' Negative Rating');
	          }
	        },
	        label: {
	          display: 'insideEnd',
			...
			Ext.create('Ext.chart.Chart', {
			    ...
			    series: [{
			        ...
			        tips: {
			          ...
			          height: 28,
			          renderer: function(storeItem, item) {
			            this.setTitle(storeItem.get('collegeId') + ': ' + storeItem.get('neutralRating') + ' Neutral Rating');
			          }
			        },
			        label: {
			          display: 'insideEnd',
