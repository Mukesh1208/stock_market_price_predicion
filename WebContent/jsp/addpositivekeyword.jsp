...
<title>Add Positive Keyword</title>
...
<%
	...
	<div class="errMsg"><% out.println(tempMsg.getMsg());%></div>
...
<form action="<%=request.getContextPath()%>/review/addPositiveKeyword.do" method="post"  >
	...
	<table>
		<tr>
			...
			<tr>
			<td><input  type="submit" value="Add Positive Keyword" onclick="validatestopword()"/></td>
		</tr>
