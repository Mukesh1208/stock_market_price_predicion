...
<%@page import="com.model.CompanyModel"%><html>
<head>
...
<%
	...
	List<CompanyModel> rankedList = (List<CompanyModel>) ajaxResponse
	.getModel();

	if (null == rankedList) {
%>
<font color="red">Ranking of Products Could not be Done
